  ...
  return (
    <div>
      ...
      <section class="text-gray-600 body-font mb-12">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img class="object-cover object-center rounded" alt="hero" src={woWeAre} />
          </div>
      ...
      <section class="text-gray-600 body-font flex">
        <div class="container mx-auto flex px-3 py-16 items-center flex-col">
          <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={ourMission} />
          <div class="text-center lg:w-2/3 w-full">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Our Mission</h1>
            <p class="mb-8 leading-relaxed">Our mission as Shopping Mall is to provide consumers with the most
        ...
        <div class="container mx-auto flex px-3 py-16 items-center flex-col">
          <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={ourVision} />
          <div class="text-center lg:w-2/3 w-full">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Our Vision</h1>
            <p class="mb-8 leading-relaxed">Our vision for a Shopping Mall is to create a user-friendly
      ...
      <h2 className=" text-4xl text-center mt-16 mb-[-50px] font-bold">WHY CHOOSE US</h2>
      <section class="text-gray-600 body-font flex items-center justify-center px-16">
        <div class="container py-24 mx-auto flex flex-wrap">
          <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Best Price</h2>
                <p class="leading-relaxed">Our Stress-Free Finance Department That Can Find Financial Solutions To Save You Money.</p>
              </div>
            </div>
          </div>
          <div class="flex relative pb-20 sm:items-center md:w-2/3">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Trusted By Thousands</h2>
                <p class="leading-relaxed lowercase">NUMBER 1 PROVIDER OF THE GRIPPING DRIVING EXPERIENCES</p>
              </div>
            </div>
          </div>
          <div class="flex relative pb-20 sm:items-center md:w-2/3">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              ...
              <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Wide Range of Brands</h2>
                <p class="leading-relaxed">We Have A Wide Range Of Different Car Brands.</p>
              </div>
            </div>
          </div>
        </div>
        <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src={whyUs} />
      </section>
    </div>
  )
}
