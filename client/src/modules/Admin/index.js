                ...
                <div class="p-4 md:w-1/3">
                  <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                    ...
                    <div class="flex-grow">
                      ...
                      <button onClick={() => approveHostel(item?._id)} class="flex mt-10 text-white bg-red-500 border-0 py-1 px-4 focus:outline-none hover:bg-red-600 rounded text-md">Approve</button>
                    </div>
                  </div>
                </div>
              )
