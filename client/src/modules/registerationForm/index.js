...
const Form = ({ isSignin }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { addressLine2, addressLines, city, cnic, contactNo, country, email, firstName, hostelAddress, hostelName, lastName, stateProvince, zipCode } = e.target.elements;

    const fields = { addressLine2, addressLines, city, cnic, contactNo, country, email, firstName, hostelAddress, hostelName, lastName, stateProvince, zipCode };
